...
CONCATENATED_NPY_SAMPLE_PATH = os.path.abspath(sys.argv[2])
...
npy_sample = np.load(CONCATENATED_NPY_SAMPLE_PATH)

processed_npy_sample = preprocess_sample(npy_sample)
