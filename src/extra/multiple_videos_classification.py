...
VIDEO_PATHS = list(map(lambda path : os.path.abspath(path), sys.argv[5:]))
...
for path in VIDEO_PATHS:
    ...
    list_result.append({"filepath": path, "predicted_value": res[0][0], "label": "normal" if res[0][0] < 0.5 else "abnormal"})
